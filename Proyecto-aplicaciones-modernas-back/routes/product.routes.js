...
} from "../services/productCatalogBootstrap.js";
...
router.post("/refresh-images", authMiddleware, adminOnly, async (req, res, next) => {
  try {
    const force = req.query.force === "1" || req.query.force === "true";
    const result = await refreshAllProductImages({ force });
    res.json({
      ok: true,
      force,
      ...result,
