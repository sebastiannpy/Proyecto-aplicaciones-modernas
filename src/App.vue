        ...
        <div class="bancosPse">
          ...
          >
            <input
              ...
              @change="errorPago = ''"
            >
            <img :src="banco.logo" :alt="banco.name" @error="onImgError">
  ...
  <div v-else>
      ...
      <main class="contenido">
        ...
        <section v-if="!cat && productoActual" class="destacado">
          ...
          <div class="cardGrande">
            <img :src="productoActual.imagen" :alt="productoActual.nombre" @error="onImgError">
        ...
        <section class="productos">
          ...
          <div v-else class="card" v-for="p in filtrados" :key="p.id" @click="abrirDetalleProducto(p)">
            ...
            <img :src="p.imagen" :alt="p.nombre" @error="onImgError">
    ...
    <div v-if="detalle" class="modal">
      <div class="modalContenido">
        ...
        <img :src="detalle.imagen" :alt="detalle.nombre" @error="onImgError">
...
export default {
  ...
  data() {
    return {
      ...
      bancosPse: [
        { name: 'Bancolombia', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Bancolombia_isologotipo.svg/120px-Bancolombia_isologotipo.svg.png' },
        { name: 'Davivienda', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Davivienda_logo.svg/120px-Davivienda_logo.svg.png' },
        { name: 'Banco de Bogotá', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Banco_de_Bogot%C3%A1_logo.svg/120px-Banco_de_Bogot%C3%A1_logo.svg.png' },
        { name: 'BBVA', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/sixty/BBVA_2019.svg/120px-BBVA_2019.svg.png' },
        { name: 'Nequi', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Nequi_logo.svg/120px-Nequi_logo.svg.png' },
      ],
      errorPago: '',
  ...
  methods: {
    ...
    onImgError(event) {
      event.target.src = 'https://placehold.co/400x300/e8e8e8/888888?text=Sin+imagen'
      event.target.onerror = null // evitar loop si el fallback también falla
    },
      ...
      try {
        ...
        this.carrito = items.map((item) => {
          ...
          const base = prodCatalogo || (prodApi ? {
            ...
            imagen: prodApi.image_url || 'https://placehold.co/400x300/e8e8e8/888888?text=Sin+imagen',
          ...
          if (!base) {
            ...
            return {
              ...
              imagen: 'https://placehold.co/400x300/e8e8e8/888888?text=No+Disponible',
              precio: 0,
